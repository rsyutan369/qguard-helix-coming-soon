          ...
          {featuresData.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute -right-4 -top-4 -z-10 h-24 w-24 rounded-full blur-2xl transition-all duration-300 group-hover:opacity-100 ${
                  isPurpleFeature ? 'bg-indigo-600/5' : 'bg-blue-600/5'
                }`} />

                {/* Styled Icon Slot */}
                <div className="mb-4 flex items-center justify-between">
                  <div className={`flex h-14 w-14 items-center justify-center rounded-xl bg-indigo-50/60 border ${
                    isPurpleFeature ? 'border-indigo-100/30 text-indigo-600' : 'border-blue-100/30 text-blue-600'
